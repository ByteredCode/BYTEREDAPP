...
async def post_documento(
    archivo: UploadFile = File(...),  # Archivo subido como multipart/form-data
    tipo_documento: str = Form(default=None),  # Campo adicional del formulario
...
async def get_documentos(
    ...
    # Los admins ven todos los docs; usuarios normales solo los propios o con permiso
    es_admin = usuario.rol in ("admin_total", "admin_empresa")
    return await listar_documentos(db, codigo_empresa, usuario.codigo_usuario, es_admin)
